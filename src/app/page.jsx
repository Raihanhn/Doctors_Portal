      ...
      <div className="w-full bg-white-A700">
        ...
        <div className="flex flex-col items-center gap-[150px] md:gap-28 sm:gap-[75px]">
          ...
          <div className="relative self-stretch">
            ...
            <div className=" bottom-0 left-0 right-0 top-0 m-auto flex h-max w-full flex-col items-end">
                  ...
                  <div className="flex w-[65%] items-center justify-between gap-5 md:w-full md:flex-col">
                    ...
                    <div className="flex gap-[19px]">
                      <Button
                        variant="outline"
                        shape="round"
                        className="min-w-[122px] font-semibold sm:px-5"
                      >
                        Log in
                      </Button>
                      <Button
              ...
              {/* specialists section */}
              <div className="relative  flex w-[100%] flex-col md:w-full md:p-5">
                <div className="flex items-center md:flex-col">
                  <Heading
                    size="2xl"
                    as="h1"
                    className=" mt-[50px] flex  mb-2 !text-blue_gray-900_01"
                  ></Heading>
                ...
                <div className="container-xs relative mt-[-32px] flex gap-5 md:flex-col">
                  {data.map((d, index) => (
                    ...
                    >
                      ...
                      <Heading
                        as="h2"
                        className="ml-3.5 mt-3 !text-gray-900_01 md:ml-0"
                      >
                        {d.covid19Test}
                      </Heading>
                      <Text
                        as="p"
                        className="mb-6 mt-1.5 w-[95%] self-end !text-blue_gray-900 md:w-full"
                      >
            ...
            {/* <div className="absolute right-[0.28px] top-[5%] m-auto flex w-[92%] items-start justify-end md:relative md:flex-col">
              ...
              <div className="relative ml-[-278px] flex flex-1 items-start justify-end md:ml-0 md:self-stretch md:p-5">
                <Text
                  size="xl"
                  as="p"
                  className="mt-44 w-[37%] !text-black-900"
                >
            ...
            {/* <div className="absolute left-[8%] top-[40%] m-auto flex w-[41%] items-center justify-between gap-5 rounded-[36px] bg-white-A700 p-[7px]">
              ...
              <Button
                size="sm"
                shape="circle"
                className="w-[56px] self-end !rounded-[28px]"
              >
            ...
            <Heading
              size="4xl"
              as="h1"
              className="absolute bottom-[41%] left-1/4 m-auto"
            >
              100+
            </Heading> */}
          </div>
          ...
          <div className="flex justify-center self-stretch bg-blue-50 py-[120px] md:py-5">
            <div className="container-xs my-[35px] flex items-start justify-between gap-5 md:flex-col md:p-5">
              <div className="flex w-[42%] flex-col md:w-full">
                ...
                <Text
                  as="p"
                  className="mt-[21px] w-[83%] !text-blue_gray-900_01 md:w-full"
                >
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sem
                  velit viverra amet faucibus.
                </Text>
              ...
              <div className="flex w-[49%] flex-col items-center gap-[45px] rounded-[20px] border border-solid border-gray-500 bg-white-A700 p-11 md:w-full md:p-5">
                ...
                <Text
                  as="p"
                  className="mb-[31px] w-[98%] !text-blue_gray-900_01 md:w-full"
                >
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sem
            ...
            <div className="flex w-[43%] flex-col md:w-full">
              <div className="flex flex-col  ">
                <Heading
                  size="2xl"
                  as="h2"
                  className="!text-blue-800 mb-[50px] "
                >
                ...
                <Text
                  as="p"
                  className="relative mt-[-37px] w-[93%] !text-blue_gray-900_01 md:w-full"
                >
              ...
              <Text
                as="p"
                className="mt-2.5 w-[93%] !text-blue_gray-900_01 md:w-full"
              >
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nec
                risus feugiat lectus risus sed ullamcorper. Auctor semper
                fermentum volutpat integer vel. In rhoncus elementum nunc,
              ...
              <Text
                as="p"
                className="mt-3.5 w-[93%] !text-blue_gray-900_01 md:w-full"
              >
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nec
                risus feugiat lectus risus sed ullamcorper. sed. Nibh est sit
                lobortis id semper.
              </Text>
              ...
              <div className="flex w-full flex-col items-center">
                <div className="flex items-center justify-between gap-5 self-stretch md:flex-col">
                  ...
                  <div className="flex w-[31%] flex-col items-start gap-[31px] md:w-full">
                    ...
                    {/* <GoogleMap
                      showMarker={false}
                      className="h-[160px] self-stretch rounded-[10px]"
                    /> */}
                    <div className="text-[16px] font-bold text-white-A700 ">
                      Google Map
                    </div>
                  </div>
                </div>
